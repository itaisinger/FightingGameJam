...
if(keyboard_check_pressed(keybinds[INPUT.heavy][true]) and keyboard_check_pressed(keybinds[INPUT.light][true]))
	log("special");
...
arr[INPUT.echo] = keyboard_check_pressed(keybinds[INPUT.echo][true]);
arr[INPUT.special] = (arr[INPUT.heavy] and arr[INPUT.light]);
