...
hitbox_data[STATES.light]		= new HitboxData(hitbox_fighter_light,4,25,5,4,4,0,0,false);
hitbox_data[STATES.heavy]		= new HitboxData(hitbox_fighter_heavy,8,100,15,5,9,0,1,false,,,,vfx_hit_strong);
hitbox_data[STATES.special]		= new HitboxData(hitbox_fighter_special,12,70,10,7,5,1,1,false,,,,vfx_hit_blue);
hitbox_data[STATES.air_light]	= new HitboxData(hitbox_fighter_air_light,5,40,5,7,7,0,0,false);
hitbox_data[STATES.air_heavy]	= new HitboxData(hitbox_fighter_air_heavy,10,90,10,3,-8,0,0,false,,,,vfx_hit_strong);
