...
function HitboxData(sprite,_damage,_stun_duration,_hitpause,_knockback_x,_knockback_y,_give_echo_charge,_is_launcher,_is_parry,_func=function(){},_hit_spd_up=3,_sfx=sfx_hit,_vfx=vfx_hit) constructor {
	sprite_index = sprite;
	damage = _damage;
